...
const Social: React.FC = () => {
    ...
    const handleCreatePost = async (e: React.FormEvent) => {
        ...
        try {
            setSubmitting(true);
            await addDoc(collection(db, 'patientPosts'), {
    ...
    const handleEditPost = async (e: React.FormEvent) => {
        ...
        try {
            setSubmitting(true);
            const postRef = doc(db, 'patientPosts', editingPost.id);
    ...
    const handleDeletePost = async (postId: string) => {
        ...
        try {
            await deleteDoc(doc(db, 'patientPosts', postId));
            await loadPosts();
        } catch (error) {
    ...
    const handleLikePost = async (post: Post) => {
        ...
        try {
            const postRef = doc(db, 'patientPosts', post.id);
    ...
    const handleAddComment = async (postId: string) => {
        ...
        try {
            ...
            const postRef = doc(db, 'patientPosts', postId);
        ...
        <div className="page-wrapper">
            ...
            <div className="page-container">
                <div className="social-header">
                    <div>
                        <h1 className="page-title">Patient Community</h1>
                        <p className="page-subtitle">Share your experiences and connect with others</p>
                    </div>
                    <button
